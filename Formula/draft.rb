...
class Draft < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "fbfab91cc8fde8d93bd2346b84d3d08453f02a398e8e8c0d74e15f2322b6b609"
    end
    on_intel do
      url "https://github.com/sebastienrousseau/draft/releases/download/v#{version}/draft_#{version}_darwin_amd64.tar.gz"
      sha256 "f79208f06261bb24757b128c3acfbd63c251a2682f119b0b951aa405eebb370e"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "240f9710a0c3578283ccaebb878f801a0cf4f9d36f5e7dec863d60f4d4d7e500"
    end
    on_intel do
      url "https://github.com/sebastienrousseau/draft/releases/download/v#{version}/draft_#{version}_linux_amd64.tar.gz"
      sha256 "da9f0f5a87a5c57ea53e40d612dc2240e3bbf403bb874e3505a8aefdad07fc43"
    end
  end

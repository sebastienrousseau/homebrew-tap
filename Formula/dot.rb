...
class Dot < Formula
  ...
  url "https://github.com/sebastienrousseau/dotfiles/releases/download/v0.2.523/dot-0.2.523.tar.gz"
  sha256 "eb3024979abb63ce985a843a6959279c89ed234804e807360e4127ea58512f4f"
  license "MIT"

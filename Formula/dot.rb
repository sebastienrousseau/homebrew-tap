...
class Dot < Formula
  ...
  url "https://github.com/sebastienrousseau/dotfiles/releases/download/v0.2.512/dot-0.2.512.tar.gz"
  sha256 "21bc95e52403a840e2d370a5b25b806020d9fdd3c2997c7159799249703810a0"
  license "MIT"
